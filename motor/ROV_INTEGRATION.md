...
|---|---|
| **Primary T2 — XW540 in thin canister** | Static O-ring sealed canister; no oil fill needed at ≤ 30 m if canister wall strength is adequate. Standard BlueROV-style aluminium tube + O-ring end-caps (≥ 3 mm wall at 30 m). |
